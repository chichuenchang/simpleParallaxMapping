...
struct MeshData
{
   ...
   MeshData() : mVao(-1), mVboVerts(-1), mVboNormals(-1), mVboTangents(-1), mVboBitangents(-1), mVboTexCoords(-1), mIndexBuffer(-1), mScaleFactor(0.0f), mScene(NULL) {}
